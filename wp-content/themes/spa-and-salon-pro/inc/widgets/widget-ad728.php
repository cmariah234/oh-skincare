...
// register spa_and_salon_728_Widget widget
function spa_and_salon_register_728_widget(){
    register_widget( 'spa_and_salon_728_Widget' );
}
add_action('widgets_init', 'spa_and_salon_register_728_widget');
 
 /**
 * Adds spa_and_salon_728_Widget widget.
 */
class spa_and_salon_728_Widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
			'spa_and_salon_728_widget', // Base ID
			__( 'RARA: AD 728 X 90', 'spa-and-salon-pro' ), // Name
			array( 'description' => __( 'A widget for 728 x 90 ad (Single banner)', 'spa-and-salon-pro' ), ) // Args
		);
    }
...
}  // class spa_and_salon_728_Widget 
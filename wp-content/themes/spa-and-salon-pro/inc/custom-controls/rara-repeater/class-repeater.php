...
class Rara_Repeater_Controler extends WP_Customize_Control {
	...
	protected function l10n( $id = false ) {
		$translation_strings = array(
			'no-image-selected' => __( 'No image selected', 'spa-and-salon-pro' ),
			'remove'            => __( 'Remove', 'spa-and-salon-pro' ),            
            'select-image'      => __( 'Select Image', 'spa-and-salon-pro' ),			
            'select-category'   => __( 'Select Category', 'spa-and-salon-pro' ),            
			'latest-posts'      => __( 'Latest Posts', 'spa-and-salon-pro' ),
			'delete'            => __( 'Delete', 'spa-and-salon-pro' ),
			'close'             => __( 'Close', 'spa-and-salon-pro' ),			
		);

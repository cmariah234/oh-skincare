...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			...
			'100light'  => esc_attr__( 'Ultra-Light 100', 'spa-and-salon-pro' ),
			...
			'400'       => esc_attr__( 'Normal 400', 'spa-and-salon-pro' ),
			...
			'600bold'   => esc_attr__( 'Semi-Bold 600', 'spa-and-salon-pro' ),

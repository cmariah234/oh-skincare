...
function spa_and_salon_customizer_theme_info( $wp_customize ) {
    ...
    $theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'View demo', 'spa-and-salon' ) . ': </label><a href="' . esc_url( 'https://raratheme.com/previews/?theme=spa-and-salon' ) . '" target="_blank">' . __( 'here', 'spa-and-salon' ) . '</a></span><br />';
	$theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'View documentation', 'spa-and-salon' ) . ': </label><a href="' . esc_url( 'https://raratheme.com/documentation/spa-and-salon/' ) . '" target="_blank">' . __( 'here', 'spa-and-salon' ) . '</a></span><br />';
	...
	$theme_info .= '<span class="sticky_info_row"><label class="more-detail row-element">' . __( 'More WordPress Themes' ,'spa-and-salon' ) . ': </label><a href="' . esc_url( 'https://raratheme.com/wordpress-themes/' ) . '" target="_blank">' . __( 'here', 'spa-and-salon' ) . '</a></span><br />';

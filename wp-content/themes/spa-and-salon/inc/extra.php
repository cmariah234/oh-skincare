...
function spa_and_salon_footer_credit(){
    ...
    $text .= '</span>';
    $text .= '<span class="by"><a href="' . esc_url( 'https://raratheme.com/wordpress-themes/spa-and-salon/' ) .'" rel="author" target="_blank">' . esc_html__( ' Spa And Salon', 'spa-and-salon' ) . '</a>' . esc_html__( ' by Rara Themes.', 'spa-and-salon' );
